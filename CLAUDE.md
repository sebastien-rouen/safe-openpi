...
8. Velocity history : JQL `sprint in closedSprints() AND project="X"` → groupé par `customfield_10020` (ou `CONFIG.sync.sprintField`)
...
5. **Table backlog** — tous les tickets non planifiés avec points, type, epic, priorité
