...
function _allTeams() {
  ...
  const fromConfig  = Object.keys(typeof CONFIG !== 'undefined' && CONFIG.teams || {})
                        .filter(t => { const teamConfig = CONFIG.teams[t] || {}; return !teamConfig.inactive && (teamConfig.sprintName || (teamConfig.futureSprintDates && teamConfig.futureSprintDates.length)); });
